...
if("TRUE" STREQUAL "TRUE")
  set(localization_data_pub_SOURCE_PREFIX /home/pi/catkin_ws/src/knight_bot/localization_data_pub)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization_data_pub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/knight_bot/localization_data_pub/${idir}'.  ${_report}")
    endif()
